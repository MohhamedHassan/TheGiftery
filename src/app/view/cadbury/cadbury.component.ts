...
@Component({
  selector: 'app-cadbury',
  templateUrl: './cadbury.component.html',
  styleUrls: ['./cadbury.component.scss']
})
export class CadburyComponent implements OnInit {
  products:Product[]=[]
  obj=[]
  amountError=-1
  isAdmin
    ...
    private _User:UserService) {
      ...
      this._ProuductService.getProductsId().subscribe(data => {
        ...
        for (let i = 0;i < this.products.length;i++) {
          if (this.products[i].category === "cad") {
